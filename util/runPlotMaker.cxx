...
int main(int argc, char** argv)
{
  ...
  string regions      = "SR_23jNOmtmax"; vector<string> regionList    ;
  string variables    = "mtmax"                              ; vector<string> variableList  ;
  string samples      = 
...
// "SameSign,ChargeFlip,Higgs,Data";
  ...
  string binValues    = "";
  if(variables == "Ht") binValues =   "8, 80, 400"                         ; 
  else if(variables == "mtmax") binValues =   "9, 20, 200"                         ; 
  else if(variables == "mlj") binValues =   "15, 0, 300"                         ; 
  else if(variables == "mljj") binValues =   "15, 0, 450"                         ; 
  vector<string> binValueList  ;
...
//   "";
  "ELREUP,ELREDOWN,MUREUP,MUREDOWN,ELFRUP,ELFRDOWN,MUFRUP,MUFRDOWN,ELFRACDOWN,ELFRACUP,MUFRACDOWN,MUFRACUP";
  vector<string> fakesystematicList;
  
  float dataBlindCut = -1.;
  string largerSmaller = "";
  if(variables == "mlj"){ largerSmaller = " >= "; dataBlindCut = 90000.; //mlj
  }
  else if(variables == "mljj"){ largerSmaller = " >= "; dataBlindCut = 120000.; // mljj  
  }
  else   if(variables == "mtmax"){ largerSmaller = " <= "; dataBlindCut = 110000.; // mtmax 
  }
  else if(variables == "Ht"){ largerSmaller = " <= "; dataBlindCut = 200000.; // Ht
  }
