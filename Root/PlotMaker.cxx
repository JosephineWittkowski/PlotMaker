...
//   cout << "DataBlindCut= " << DataBlindCut << endl;
  ...
  if(!(region.Contains("EE_") || region.Contains("MM_") || region.Contains("EM_"))){ 
  ...
  if(region.Contains("_letpPt")) cutflowstage = "\\ptlead{} / \\ptsubl{}";
...
//   }
  ...
  if(m_table) cout << "& & & & & & & =(130,0)~GeV \\\\" << endl;
...
//     cout << " ratio_raw->GetPoint x1= " << x1 << " y1= " << y1 << endl;
  ...
  TString plotName = "/data/etp3/jwittkow/analysis_SUSYTools_03_04_SusyNt_01_16/pics_KinematicPlotter/kinematics_" + region + "_" + variable + "_May_19.pdf" ;
  TString plotNameeps = "/data/etp3/jwittkow/analysis_SUSYTools_03_04_SusyNt_01_16/pics_KinematicPlotter/kinematics_" + region + "_" + variable + "_May_19.eps" ;
