...
//   }
  ...
  cout << "nominalAsymErrorsMCBg->GetY()[0]= " << nominalAsymErrorsMCBg->GetY()[0] << endl;
...
// 7) Add squared 17.4% * WZ nominal yield to total error for the uncertainty on the WZ background.
  ...
  TArrow* arrow = new TArrow(m_dataBlindCut/1000.,0,m_dataBlindCut/1000.,histograms[dataIndex]->GetMaximum()*3,0.03,"<|");
